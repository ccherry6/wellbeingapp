/*
  ...
  1. Changes
    ...
    - Set default notification preferences to 8:00 AM Australian Pacific Time
...
-- Update existing users with default notification settings (8:00 AM Australian Pacific Time)
