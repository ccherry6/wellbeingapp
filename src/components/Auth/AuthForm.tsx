        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">
              <span className="text-blue-900">Reset Password</span>
            </h1>
            <p className="text-gray-600">
              {resetSent ? 'Check your email' : 'Enter your email to reset your password'}
            </p>
          </div>
          ...
          {resetSent ? (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-blue-900 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-800 transition-all"
              >
                Back to Sign In
              </button>
            </div>
            ...
            <form onSubmit={handlePasswordReset} className="space-y-4">
              ...
              <button
                ...
                className="w-full text-blue-900 hover:text-blue-800 font-medium"
              >
                Back to Sign In
              </button>
            </form>
