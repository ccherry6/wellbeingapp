/*
  # Fix HTTP Post Function Call

  1. Updates
    - Corrects check_critical_scores function to use net.http_post instead of extensions.http_post
    - pg_net extension installs functions in the 'net' schema, not 'extensions'
    
  2. Behavior
    - Ensures critical alert emails can be sent successfully
    - Uses correct function signature for pg_net
*/
...
DECLARE
    ...
    _supabase_url text := 'https://vapegdmsvilttrtvypnc.supabase.co';
    _anon_key text := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZhcGVnZG1zdmlsdHRydHZ5cG5jIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjU1MDQ5MTEsImV4cCI6MjA0MTA4MDkxMX0.x_K9Ga33EXEZmPZlm-vQ-5P8hXYjxqwVBp_9nGo3pQs';
    _function_url text;
    _payload jsonb;
    _request_id bigint;
