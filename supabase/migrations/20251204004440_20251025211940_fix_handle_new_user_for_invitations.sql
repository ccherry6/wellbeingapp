/*
  # Fix handle_new_user to use invitation_tokens table

  1. Changes
    - Update trigger to check invitation_tokens instead of coach_invitations
    - Use invitation data to set correct role during signup
