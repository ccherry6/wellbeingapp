...
DROP POLICY IF EXISTS "Students can update own wellness entries" ON wellness_entries;
DROP POLICY IF EXISTS "Coaches can update all wellness entries" ON wellness_entries;
DROP POLICY IF EXISTS "Students can delete recent wellness entries" ON wellness_entries;
DROP POLICY IF EXISTS "Coaches can delete any wellness entry" ON wellness_entries;
